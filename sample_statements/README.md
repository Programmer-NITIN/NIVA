...
These realistic Indian bank statement CSV files can be uploaded during the **Step 2 (Data Aggregation & Consent)** onboarding stage to verify parsing, Financial Digital Twin calculation, Responsible Gate underwriting, and Empathetic intervention flows.

---

## Available Sample Files

### 1. `sbi_salaried_statement.csv` (Healthy Salaried Professional)
...
### 2. `hdfc_kirana_merchant_statement.csv` (Micro-Business & MSME)
...
### 3. `icici_stressed_medical_statement.csv` (Cash-Strained / Empathetic Relief Trigger)
- **Bank**: ICICI Bank
...
3. In **Step 2 (Data Aggregation)**: Click the **Upload Bank Statement (CSV / Excel)** tab.
4. Click **Select Statement File** and choose one of the CSV files from `c:\Users\nitin\NIVA hackout\sample_statements\`.
5. Enter your Full Name and click **Upload & Parse Statement**.
6. Watch NIVA parse transactions into ReBIT 1.1 format, generate your **Financial Digital Twin**, and unlock your personalized **Customer Dashboard**!
